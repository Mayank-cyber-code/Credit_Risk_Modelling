...
# Modeling: 
Baseline (Random Forest, Decision Tree), advanced (XGBoost with multi-class outputs).

# Hyperparameter Optimization: 
Grid search across key XGBoost settings (learning rate, tree depth, column sample, L1 regularization, estimators).

# Result Analysis: 
Accuracy, precision-recall-F1 for all classes; best parameter set tracking and export to Excel.
